...
public class AttestFunction implements FREFunction {
    ...
    private void attest() {
        Log.v(TAG, "AttestFunction - attest");
        String attestResult = AndroidAttestStatics.attest(AndroidAttestExtension.appContext);
        AndroidAttestExtension.dispatch(AndroidAttestActions.ATTEST, attestResult);
    }
...
class AndroidAttestStatics {
    ...
    public static String attest(Context ctx) {
        ...
        try {
            ...
            Log.e("AndroidAttestStatics", "error: " + exception.getMessage(), exception);
        }
